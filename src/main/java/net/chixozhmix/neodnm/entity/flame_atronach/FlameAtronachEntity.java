package net.chixozhmix.neodnm.entity.flame_atronach;
...
public class FlameAtronachEntity extends AbstractSpellCastingMob implements IMagicSummon, GeoEntity {
    ...
    public static AttributeSupplier.Builder prepareAttributes() {
        return LivingEntity.createLivingAttributes()
                ...
                .add(AttributeRegistry.SPELL_POWER, (double)0.3F)
