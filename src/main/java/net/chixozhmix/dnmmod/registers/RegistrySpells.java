...
import net.chixozhmix.dnmmod.spells.evocation.*;
import net.chixozhmix.dnmmod.spells.fire.SummonFlameAtronach;
import net.chixozhmix.dnmmod.spells.ice.AgathysArmorSpell;
...
public class RegistrySpells {
    ...
    public static final Supplier<AbstractSpell> MAGE_ARMOR = registerSpell(new MageArmorSpell());
